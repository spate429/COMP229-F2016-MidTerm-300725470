<%@ Page Title="Todo Details" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TodoDetails.aspx.cs" Inherits="COMP229_F2016_MidTerm_300725470.TodoDetails" %>
            ...
            <div class="col-md-offset-3 col-md-6">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox runat="server" CssClass="form-control" ID="TodoIDTextBox" 
                        placeholder="TodoID" required="true"></asp:TextBox>
                </div>
